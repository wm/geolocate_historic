...
Download list of historic places in the northeast region provided by the National Register of Historic Places: "http://www.cs.tufts.edu/comp/120/assignments/ne_landmarks.zip":ne_landmarks.zip (CSV, comma-separated, file compressed to ZIP).  The list has 18,246 records.  Write a Ruby script to parse the CSV file and create a SQL file of insert statements for the historic places table in MySQL.  The CSV file has four (4) columns:
